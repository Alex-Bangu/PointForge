...
function Forgot() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await unauthenticatedFetch('/auth/resets', {
                method: 'POST',
            ...
            setSuccess("Check your UofT email for further steps on resetting your password. You have 1 hour until the reset link expires.");
        } catch (err) {
