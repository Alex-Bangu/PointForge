...
async function main() {
  ...
  const eventData = [
    {
      name: 'Welcome Social', description: 'A casual meet-and-greet event.', location: 'Bahen', 
      placeId: 'ChIJV8llUcc0K4gRe7a0R0E4WWQ',
    ...
    {
      name: 'Coding Workshop', description: 'Deep dive into Express.js.', location: 'Hart House', 
      placeId: 'ChIJVQ-udbk0K4gRjxaCU5L06yg',
    ...
    {
      name: 'Spring Gala', description: 'Annual fancy dinner.', location: 'Sandford Flemming Building', 
      placeId: 'ChIJJ9rOg7g0K4gRAp0rkY8SPYk',
    ...
    {
      name: 'Unpublished Demo', description: 'Secret event for staff only.', location: 'Myhal Centre', 
    ...
    {
        name: 'Full RSVP Event', description: 'A small, fully booked session.', location: 'McLennan Physical Laboratories', 
        placeId: 'ChIJU5c3aL80K4gROWk2H8QMilI',
    ...
    {
        name: 'Unlimited Capacity Talk', description: 'A large, open talk on AI.', location: 'Robarts Library', 
        placeId: 'ChIJZ48Dhb40K4gRqfQuu9-I0Hw',
